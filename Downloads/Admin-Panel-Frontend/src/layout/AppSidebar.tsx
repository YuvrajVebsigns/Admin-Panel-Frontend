          ...
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              <Image
                ...
                src="/images/logo/core-media-logo3.webp"
                alt="Logo"
                width={150}
                height={40}
              />
              <Image
                ...
                src="/images/logo/core-media-logo-dark.png"
                alt="Logo"
                width={150}
                height={40}
              />
            ...
            <Image src="/images/logo/sidebar-logo.png" alt="Logo" width={32} height={32} />
          )}
        </Link>
      </div>
